...
from .raster import read_meta, write_raster_blockwise
...
class SlopeUnits:
    ...
    def run(self, dem_path, output_path, *, work_dir, vector_path=None, vector_layer="slope_units"):
        ...
        # 1. Hydrology and corrected stream-only candidate hierarchy.
        ...
        # 2. Build reusable nested intersection DAG once.
        ...
        # 3. Parameter-dependent graph cut + final GRASS-like fill/clump.
